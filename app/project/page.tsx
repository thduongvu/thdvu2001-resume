            ...
            <div className={styles.content}>
                <ul className={styles.listing_tags}>
                    <li>
                        ...
                        <Image src="/blog-articles.svg" alt="tab1" width={18} height={14} priority/>
                        &nbsp;
                        All 
                    ...
                    <li>
                        ...
                        <Image src="/blog-partners.svg" alt="tab2" width={18} height={14} priority/>
                        &nbsp;
                        Work Experience
                        <div className={styles.tabs_under_hover}></div>
                        </Link>
                    ...
                    <li>
                        ...
                        <Image src="/resources-guide.svg" alt="tab3" width={14} height={18} priority/>
                        &nbsp;
                        Course Projects
                        <div className={styles.tabs_under_hover}></div>
                        </Link>
